...
public final class FeignClientConstants {
	...
	public static final String EMPLOYEE_SERVICE_KEY = "sk-group-ms-employee-service";
	...
	public static final String ORGANIZATION_SERVICE_KEY = "sk-group-ms-organization-service";
