...
public final class FeignClientConstants {
	...
	public static final String API_GATEWAY_URL = "http://localhost:8761/";
	
	// Start - EMPLOYEE_SERVICE Feign entries
	public static final String EMPLOYEE_SERVICE_KEY = "EMPLOYEE_SERVICE";
	...
	public static final String EMPLOYEE_SERVICE_GET_PERSONAL_INFO = "/getEmployeePersonalInfo/{employeeId}";
	...
	public static final String ORGANIZATION_SERVICE_KEY = "ORGANIZATION_SERVICE";
